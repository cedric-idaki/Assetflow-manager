    ...
    <style>
      ...
      <div class="meta">
        <div>
          ...
          ${txn?.accountNumber && txn.accountNumber !== '-' ? `<div class="muted">${txn.accountNumber}</div>` : ''}
          ${txn?.clientEmail ? `<div class="muted">${txn.clientEmail}</div>` : ''}
          ${txn?.clientPhone ? `<div class="muted">${txn.clientPhone}</div>` : ''}
        </div>
        <div class="right">
      ...
      <table class="items">
        ...
        <tbody>
          <tr>
            <td>${lineDesc}${txn?.assetCode ? `<div class="muted">${txn.assetCode}</div>` : ''}</td>
      ...
      ${txn?.notes ? `<div class="note">Note: ${txn.notes}</div>` : ''}
