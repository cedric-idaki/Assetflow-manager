// The 47 counties of Kenya, alphabetical. Used as the City/County dropdown
// options in Sacco registration (and anywhere else a county picker is needed).
...
// Constituencies (locations) within each county, keyed by the exact county
// names above. Used as the dependent Location dropdown in Sacco registration:
// pick a county first, then a location within it.
export const LOCATIONS_BY_COUNTY = {
