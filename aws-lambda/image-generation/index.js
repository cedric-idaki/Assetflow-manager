...
const { imageGeneration } = require('@rocketnew/llm-sdk');
    ...
    if (!prompt) {
      return {
        ...
        body: JSON.stringify({
          ...
          details: 'The request must include a prompt describing the image to generate',
        }),
      };
    }
    ...
    if (!model) {
      return {
        ...
        body: JSON.stringify({
          ...
          details: 'The request must include a model name for image generation',
        }),
      };
    }
